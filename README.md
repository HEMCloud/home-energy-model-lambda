...
- lambda_function - Code for the application's Lambda function.
...
The AWS SAM CLI installs dependencies defined in `lambda_function/package.json`, creates a deployment package, and saves it in the `.aws-sam/build` folder.
