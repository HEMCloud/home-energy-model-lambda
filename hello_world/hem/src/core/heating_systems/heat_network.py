...
class HeatNetworkServiceWaterStorage(HeatNetworkService):
    ...
    def energy_output_max(self, temp_return):
        ...
        return self._heat_network._HeatNetwork__energy_output_max(self.__controlmax.setpnt())
...
class HeatNetworkServiceSpace(HeatNetworkService):
    ...
    def energy_output_max(self, temp_output, temp_return_feed, time_start=0.0):
        ...
        return self._heat_network._HeatNetwork__energy_output_max(temp_output, time_start)
...
class HeatNetwork:
    ...
    def create_service_hot_water_storage(self, service_name, controlmin=None, controlmax=None):
